...
namespace J03L_Command_Line_Installer_API
{
    public class J03L_CLIAPI
    {
        ...
        public static string VERSION = "0.0.1-initial";
        public static void CLIinfo()
        {
...
https://github.com/joelastley555/J03L-CL-Installer-API/blob/master/LICENSE");   
        ...
        public static void CreateInstaller(string installName, bool installFromInternet, bool hasLicense, bool mustScrollToAccept, string licenseText)
        {

        }
        public static bool ShowLicense(string licenseText)
        {
